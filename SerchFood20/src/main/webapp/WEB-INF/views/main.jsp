...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-light static-top">
      <div class="container">
        <a class="navbar-brand" href="#">밥먹고 합시다</a>
    ...
    <header class="masthead text-white text-center">
      <img class="overlay" src="${pageContext.request.contextPath}/resources/img/testimonials-3.jpg"></img>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
            <form action="main.sf" method="post">
              <div class="form-row">
